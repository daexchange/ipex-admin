...
import ai.turbochain.ipex.core.AdminRealm;
...
public class ShiroConfig {
    ...
    @DependsOn("lifecycleBeanPostProcessor")
    public AdminRealm adminRealm(RedisCacheManager redisCacheManager) {
        ...
        adminRealm.setCacheManager(redisCacheManager);
        return adminRealm;
    }
    ...
    @DependsOn({"adminRealm","sessionManager","redisCacheManager","cookieRememberMeManager"})
    public DefaultWebSecurityManager getDefaultWebSecurityManager(AdminRealm adminRealm,SessionManager sessionManager, 
    		RedisCacheManager redisCacheManager,CookieRememberMeManager cookieRememberMeManager) {
